...
public class VeiculoDAO implements Serializable {
    ...
    public VeiculoDAO(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Veiculo veiculo) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            try {
                ...
                throw new RollbackFailureException("rollback", re);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(Veiculo veiculo) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Long id = veiculo.getId_veiculo();
                if (findVeiculo(id) == null) {
                    throw new NonexistentEntityException(id + " no exist");
                }
            }
            throw ex;
        } finally {
    ...
    public void destroy(Long id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException(id + " no exists", enfe);
            }
            em.remove(veiculo);
            utx.commit();
        } catch (Exception ex) {
